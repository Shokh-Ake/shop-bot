...
def get_categories_buttons(category_list):
    ...
    for item in category_list:
        ...
        if category_name == 'uy-uchun':
            name = "Uy uchun"
        elif category_name == 'bolalar-uchun':
            name = "Bolalar uchun"
        elif category_name == 'sovga':
            name = "Sovg'a"
        elif category_name == 'ayollar':
            name = "Ayollar uchun"
        elif category_name == 'davolovchi-mahsulotlar':
            name = "Davolovchi mahsulotlar"
        elif category_name == 'erkaklar-uchun':
            name = "Erkaklar uchun"
        elif category_name == 'fitnes':
            name = "Fitnes"
        elif category_name == 'davolovchi-mazlar':
            name = "Davolovchi mazlar"
        elif category_name == 'moshina-uchun':
            name = "Moshina uchun"
